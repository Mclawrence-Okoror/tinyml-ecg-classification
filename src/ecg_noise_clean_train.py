...
print()
print("=" * 60)
print("TRAINING MODEL ON CLEAN ECG DATA")
print("=" * 60)
...
print()
print("=" * 60)
print("EXPERIMENT 3B — CLEAN TRAINING → NOISY TESTING")
print("=" * 60)
...
for condition, noise_level in noise_conditions.items():
    ...
    print(f"Abnormal precision: {precision:.4f}")
    print(f"Abnormal recall:    {recall:.4f}")
